  ...
  <div class="card-footer clearfix">
    <ul class="pagination m-0 float-right">
      ...
      <li
        ...
        v-for="index in tatolpagedata"
        v-bind:Key="index"
        :class="index - 1 == curpagedata ? 'active' : ''"
      >
        <a class="page-link" href="#" @click="querybypage(index - 1)">{{
          index
        }}</a>
      </li>
      ...
      >
        <a
          href="#"
          :class="index == curpagedata ? 'page-link' : ''"
          @click="querybypage(index - 1)"
